<template>
  <page-card name="资源配额检查">
    <v-card-text>
      <v-tabs v-model="tabValue">
        <v-tab>资源配额检查执行次数(次)</v-tab>
        <v-tab @change="change2()">资源配额检查执行平均时长(秒)</v-tab>
        <v-tab @change="change3()">资源配额检查执行周环比(次)</v-tab>
        <v-tab @change="change4()">资源配额检查执行状态比率(比率)</v-tab>
        <v-tab @change="change5()">已使用memoryRequest平均值</v-tab>
        <v-tab @change="change6()">已使用memoryLimit平均值</v-tab>
        <v-tab @change="change7()">已使用cpuRequest平均值</v-tab>
        <v-tab @change="change8()">已使用cpuLimit平均值</v-tab>
        <v-tab @change="change9()">已使用pods平均值</v-tab>
        <v-tab @change="change10()">已使用memoryRequest比率</v-tab>
        <v-tab @change="change11()">已使用memoryLimit比率</v-tab>
        <v-tab @change="change12()">已使用cpuRequest比率</v-tab>
        <v-tab @change="change13()">已使用cpuLimit比率</v-tab>
        <v-tab @change="change14()">已使用pods比率</v-tab>
      </v-tabs>
        ...
        <v-tab-item>
          <v-form>
            <v-container class="d-flex flex-wrap">
              ...
              ></v-select>
              <v-select
                :items="moduleTypesList"
                label="模块类型"
                class="mr-8"
                dense
                small-chips
                multiple
                v-model="chartParams.moduleTypes"
                @change="getEcharts()"
              ></v-select> -->
            </v-container>
          </v-form>
          ...
          <v-form>
            <v-container class="d-flex flex-wrap">
              ...
              <v-select
                ...
                small-chips
                multiple
                v-model="chartParams2.moduleTypes"
                @change="getEcharts2()"
              ></v-select> -->
            </v-container>
          </v-form>
          ...
          <v-form>
            <v-container class="d-flex flex-wrap">
              ...
              <v-select
                ...
                small-chips
                multiple
                v-model="chartParams3.moduleTypes"
                @change="getEcharts3()"
              ></v-select> -->
            </v-container>
          </v-form>
          ...
          <v-form>
            <v-container class="d-flex flex-wrap">
              ...
              <v-select
                ...
                small-chips
                multiple
                v-model="chartParams4.moduleTypes"
                @change="getEcharts4()"
              ></v-select> -->
            </v-container>
          </v-form>
          ...
          <v-form>
            <v-container class="d-flex flex-wrap">
              ...
              <v-select
                ...
                class="mr-8"
                dense
                v-model="chartParams5.timeRageDays"
                @change="timeRageDaysChange5(chartParams5.timeRageDays)"
              ></v-select>
              <template>
                <v-menu
                  v-model="menu5"
          ...
          <v-form>
            <v-container class="d-flex flex-wrap">
              ...
              <v-select
                ...
                class="mr-8"
                dense
                v-model="chartParams6.timeRageDays"
                @change="timeRageDaysChange6(chartParams6.timeRageDays)"
              ></v-select>
              <template>
                <v-menu
                  v-model="menu6"
          ...
          <v-form>
            <v-container class="d-flex flex-wrap">
              ...
              <v-select
                ...
                class="mr-8"
                dense
                v-model="chartParams7.timeRageDays"
                @change="timeRageDaysChange7(chartParams7.timeRageDays)"
              ></v-select>
              <template>
                <v-menu
                  v-model="menu7"
          ...
          <v-form>
            <v-container class="d-flex flex-wrap">
              ...
              <v-select
                ...
                class="mr-8"
                dense
                v-model="chartParams8.timeRageDays"
                @change="timeRageDaysChange8(chartParams8.timeRageDays)"
              ></v-select>
              <template>
                <v-menu
                  v-model="menu8"
          ...
          <v-form>
            <v-container class="d-flex flex-wrap">
              ...
              <v-select
                ...
                class="mr-8"
                dense
                v-model="chartParams9.timeRageDays"
                @change="timeRageDaysChange9(chartParams9.timeRageDays)"
              ></v-select>
              <template>
                <v-menu
                  v-model="menu9"
          ...
          <v-form>
            <v-container class="d-flex flex-wrap">
              ...
              <v-select
                ...
                class="mr-8"
                dense
                v-model="chartParams10.timeRageDays"
                @change="timeRageDaysChange10(chartParams10.timeRageDays)"
              ></v-select>
              <template>
                <v-menu
                  v-model="menu10"
          ...
          <v-form>
            <v-container class="d-flex flex-wrap">
              ...
              <v-select
                ...
                class="mr-8"
                dense
                v-model="chartParams11.timeRageDays"
                @change="timeRageDaysChange11(chartParams11.timeRageDays)"
              ></v-select>
              <template>
                <v-menu
                  v-model="menu11"
          ...
          <v-form>
            <v-container class="d-flex flex-wrap">
              ...
              <v-select
                ...
                class="mr-8"
                dense
                v-model="chartParams12.timeRageDays"
                @change="timeRageDaysChange12(chartParams12.timeRageDays)"
              ></v-select>
              <template>
                <v-menu
                  v-model="menu12"
          ...
          <v-form>
            <v-container class="d-flex flex-wrap">
              ...
              <v-select
                ...
                class="mr-8"
                dense
                v-model="chartParams13.timeRageDays"
                @change="timeRageDaysChange13(chartParams13.timeRageDays)"
              ></v-select>
              <template>
                <v-menu
                  v-model="menu13"
          ...
          <v-form>
            <v-container class="d-flex flex-wrap">
              ...
              <v-select
                ...
                class="mr-8"
                dense
                v-model="chartParams14.timeRageDays"
                @change="timeRageDaysChange14(chartParams14.timeRageDays)"
              ></v-select>
              <template>
                <v-menu
                  v-model="menu14"
...
export default {
  ...
  data () {
    return {
      ...
      timeRageStatus5: true,
      timeRageStatus6: true,
      timeRageStatus7: true,
      timeRageStatus8: true,
      timeRageStatus9: true,
      timeRageStatus10: true,
      timeRageStatus11: true,
      timeRageStatus12: true,
      timeRageStatus13: true,
      timeRageStatus14: true,
      dimensionList: [
        { text: 'all（全部）', value: 'all' },
        { text: 'projectName（项目）', value: 'projectName' },
        { text: 'projectTeam（团队）', value: 'projectTeam' },
  ...
  created () {
    ...
    request.get('/metrics/checkQuotas/options').then(response => {
      ...
      // vm.moduleTypesList = response.data.moduleTypes
    })
  },
  mounted () {
    const vm = this
  ...
  methods: {
    ...
    getEcharts5 () {
      ...
      var colorList2 = [...colorList]
      var i = Math.floor(Math.random() * colorList2.length);
      if(vm.chartParams5.timeRageDays == 0 && vm.dates5.length == 0){
        vm.warnTip(true, '请选择自定义时间区间')
      }else{
        if(vm.myChart5){
          vm.myChart5.destroy()
        ...
        vm.chartParams5.timeRage.startDate = dates[0]
        vm.chartParams5.timeRage.endDate = dates[1]
    ...
    getEcharts6 () {
      ...
      var colorList2 = [...colorList]
      var i = Math.floor(Math.random() * colorList2.length);
      if(vm.chartParams6.timeRageDays == 0 && vm.dates6.length == 0){
        vm.warnTip(true, '请选择自定义时间区间')
      }else{
        if(vm.myChart6){
          vm.myChart6.destroy()
        ...
        vm.chartParams6.timeRage.startDate = dates[0]
        vm.chartParams6.timeRage.endDate = dates[1]
    ...
    getEcharts7 () {
      ...
      var colorList2 = [...colorList]
      var i = Math.floor(Math.random() * colorList2.length);
      if(vm.chartParams7.timeRageDays == 0 && vm.dates7.length == 0){
        vm.warnTip(true, '请选择自定义时间区间')
      }else{
        if(vm.myChart7){
          vm.myChart7.destroy()
        ...
        vm.chartParams7.timeRage.startDate = dates[0]
        vm.chartParams7.timeRage.endDate = dates[1]
    ...
    getEcharts8 () {
      ...
      var colorList2 = [...colorList]
      var i = Math.floor(Math.random() * colorList2.length);
      if(vm.chartParams8.timeRageDays == 0 && vm.dates8.length == 0){
        vm.warnTip(true, '请选择自定义时间区间')
      }else{
        if(vm.myChart8){
          vm.myChart8.destroy()
        ...
        vm.chartParams8.timeRage.startDate = dates[0]
        vm.chartParams8.timeRage.endDate = dates[1]
    ...
    getEcharts9 () {
      ...
      var colorList2 = [...colorList]
      var i = Math.floor(Math.random() * colorList2.length);
      if(vm.chartParams9.timeRageDays == 0 && vm.dates9.length == 0){
        vm.warnTip(true, '请选择自定义时间区间')
      }else{
        if(vm.myChart9){
          vm.myChart9.destroy()
        ...
        vm.chartParams9.timeRage.startDate = dates[0]
        vm.chartParams9.timeRage.endDate = dates[1]
    ...
    getEcharts10 () {
      ...
      var colorList2 = [...colorList]
      var i = Math.floor(Math.random() * colorList2.length);
      if(vm.chartParams10.timeRageDays == 0 && vm.dates10.length == 0){
        vm.warnTip(true, '请选择自定义时间区间')
      }else{
        if(vm.myChart10){
        ...
        vm.chartParams10.timeRage.startDate = dates[0]
        vm.chartParams10.timeRage.endDate = dates[1]
    ...
    getEcharts11 () {
      ...
      var colorList2 = [...colorList]
      var i = Math.floor(Math.random() * colorList2.length);
      if(vm.chartParams11.timeRageDays == 0 && vm.dates11.length == 0){
        vm.warnTip(true, '请选择自定义时间区间')
      }else{
        if(vm.myChart11){
        ...
        vm.chartParams11.timeRage.startDate = dates[0]
        vm.chartParams11.timeRage.endDate = dates[1]
    ...
    getEcharts12 () {
      ...
      var colorList2 = [...colorList]
      var i = Math.floor(Math.random() * colorList2.length);
      if(vm.chartParams12.timeRageDays == 0 && vm.dates12.length == 0){
        vm.warnTip(true, '请选择自定义时间区间')
      }else{
        if(vm.myChart12){
        ...
        vm.chartParams12.timeRage.startDate = dates[0]
        vm.chartParams12.timeRage.endDate = dates[1]
    ...
    getEcharts13 () {
      ...
      var colorList2 = [...colorList]
      var i = Math.floor(Math.random() * colorList2.length);
      if(vm.chartParams13.timeRageDays == 0 && vm.dates13.length == 0){
        vm.warnTip(true, '请选择自定义时间区间')
      }else{
        if(vm.myChart13){
        ...
        vm.chartParams13.timeRage.startDate = dates[0]
        vm.chartParams13.timeRage.endDate = dates[1]
    ...
    getEcharts14 () {
      ...
      var colorList2 = [...colorList]
      var i = Math.floor(Math.random() * colorList2.length);
      if(vm.chartParams14.timeRageDays == 0 && vm.dates14.length == 0){
        vm.warnTip(true, '请选择自定义时间区间')
      }else{
        if(vm.myChart14){
        ...
        vm.chartParams14.timeRage.startDate = dates[0]
        vm.chartParams14.timeRage.endDate = dates[1]
    ...
    timeRageDaysChange5 (value) {
      if(value == 0){
        this.warnTip(true, '请选择自定义时间区间')
        this.timeRageStatus5 = false
      }else{
        this.dates = []
        this.timeRageStatus5 = true
        this.getEcharts5()
      }
    },
    timeRageDaysChange6 (value) {
      if(value == 0){
        this.warnTip(true, '请选择自定义时间区间')
        this.timeRageStatus6 = false
      }else{
        this.dates = []
        this.timeRageStatus6 = true
        this.getEcharts6()
      }
    },
    timeRageDaysChange7 (value) {
      if(value == 0){
        this.warnTip(true, '请选择自定义时间区间')
        this.timeRageStatus7 = false
      }else{
        this.dates = []
        this.timeRageStatus7 = true
        this.getEcharts7()
      }
    },
    timeRageDaysChange8 (value) {
      if(value == 0){
        this.warnTip(true, '请选择自定义时间区间')
        this.timeRageStatus8 = false
      }else{
        this.dates = []
        this.timeRageStatus8 = true
        this.getEcharts8()
      }
    },
    timeRageDaysChange9 (value) {
      if(value == 0){
        this.warnTip(true, '请选择自定义时间区间')
        this.timeRageStatus9 = false
      }else{
        this.dates = []
        this.timeRageStatus9 = true
        this.getEcharts9()
      }
    },
